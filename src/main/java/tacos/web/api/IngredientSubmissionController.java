...
public class IngredientSubmissionController {
   ...
   /* @GetMapping("/")
    public Mono<ResponseEntity<Flux<Ingredient>>> getAllIngredients() {
        Flux<Ingredient> ingredients = ingredientService.findAllIngredients();
        return Mono.just(ResponseEntity.ok(ingredients)); // Mono wrapping ResponseEntity
    }*/
